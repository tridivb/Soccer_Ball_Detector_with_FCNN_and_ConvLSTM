...
class ConvGRUCell(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, kernel_size, device=torch.device('cuda')):
        super().__init__()
...
class ConvGRU(nn.Module):
    ...
    def __init__(self, input_size, hidden_sizes, kernel_sizes, n_layers, device=torch.device('cuda')):
        '''
