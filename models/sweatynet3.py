...
class SweatyNet3(nn.Module):
    def __init__(self, device):
        ...
        self.seq3 = nn.Sequential(
            nn.Conv2d(in_channels=24, out_channels=16, kernel_size=1, stride=1, padding=0),
            nn.BatchNorm2d(16),
            nn.ReLU(),
        ...
        self.seq4 = nn.Sequential(
            nn.Conv2d(in_channels=56, out_channels=32, kernel_size=1, stride=1, padding=0),
            nn.BatchNorm2d(32),
            nn.ReLU(),
        ...
        self.seq5 = nn.Sequential(
            nn.Conv2d(in_channels=120, out_channels=64, kernel_size=1, stride=1, padding=0),
            nn.BatchNorm2d(64),
            nn.ReLU(),
